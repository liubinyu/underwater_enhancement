# Rule and Base VLM baseline report

Base VLM inference results are unavailable; no rule-versus-VLM quality conclusion can be made.

## Evidence available

- Rule rows: 10
- Successful Base VLM inferences: 0
- Completed diagnosis reviews: 0
- Completed preference reviews: 0
